...
function Slider({title, image, date, verification, issuer}: any) {
    return (
        <div className={`md:w-[19rem] md:h-[26rem] flex flex-col items-center justify-between rounded-xl shadow-2xl inset-2 md:mx-3 my-5 xs:w-[47vw] xs:h-[40vh] xs:mx-1`}>
            ...
            <div className={`w-full md:h-[7rem] flex flex-col items-start justify-between rounded-lg px-2 xs:h-[9rem]`}>
                ...
                <div className={`w-full h-[2rem] flex items-center justify-between rounded-lg`}>
                    ...
                    <div className={`w-[5rem] h-[1.5rem] flex items-center justify-around rounded-lg bg-gray-100`}>
...
function Certifications() {
    ...
    return (
        <div className={`md:min-w-[100%] md:min-h-[100vh] h-[100vh] md:mb-0 flex flex-row items-center xs:justify-center xs:min-h-[80vh] xs:h-[80vh] xs:mb-[2rem]`} id='certifications'>
            <div className={`w-full h-full flex flex-col border-b-2 mt-[3rem]`}>
                ...
                <div className={`flex-1 w-full flex flex-col items-center justify-between overflow-x-scroll overflow-y-hidden scrollbar-hidden`}>
                    ...
                    <div className={`md:w-[90%] flex-1 flex flex-wrap items-center justify-center overflow-y-scroll overflow-x-hidden scrollbar-hidden xs:w-full`}>
