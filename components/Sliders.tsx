...
function Slide({ title, live_link, image, prd_link }: any) {
    return (
        <div className={`md:h-[15rem] md:min-w-[28rem] md:w-[28rem] my-2 mr-3 flex justify-between items-start flex-col rounded-xl hover:scale-[102%] xs:h-[11rem] xs:min-w-[22rem] xs:w-[22rem]`}>
...
function Sliders({ data, title, id }: any) {
    ...
    return (
        <div className={`w-[100%] md:min-h-[110vh] md:h-[110vh] flex flex-col items-center justify-between xs:min-h-[110vh] xs:h-auto`} id={id}>
            <div className={`w-full h-full flex flex-col border-b-2 mt-[3rem]`}>
                ...
                <div className={`w-full h-[60%] flex md:flex-row xs:flex-col-reverse`}>
                    <div className={`md:w-[50%] md:h-full flex flex-col items-center justify-center flex-y-2 xs:w-full xs:h-[50%]`}>
                        <div className={`md:w-[80%] flex items-center justify-start md:my-1 md:mt-0 xs:w-[98%] xs:mt-5`}>
                            <Clock className={`mr-2 text-black font-bold w-xl`} />
                            <p className={`text-start text-black my-2 text-sm`}>{data[0].publication_date}</p>
                        </div>
                        <div className={`w-[80%] flex items-center justify-start md:my-1 xs:w-[98%]`}>
                ...
                <div className={`w-full h-[40%] flex flex-row items-center justify-between overflow-x-scroll overflow-y-hidden scrollbar-hidden md:mt-0 xs:mt-[2rem]`}>
